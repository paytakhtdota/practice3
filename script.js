...
document.querySelector("#ref-link").classList = "new-class red-text"

result=document.querySelector("#ref-link").classList;
console.log(result);

document.querySelector("#ref-link").removeAttribute("class");
console.log(document.querySelector("#ref-link").attributes);
document.querySelector("#ref-link").className = "red-text";
document.querySelector("#ref-link").removeAttribute("class");

// ساده ترین روش و اسان ترین روش استفاده از متود setAttribute("","")

document.querySelector("#ref-link").setAttribute("class","red-text");
console.log(document.querySelector("#ref-link").attributes);

// شما در اچتمل اتریبیوت شخصی خودتان که اصلا وجود ندارد را قرار بدهید برای گفتم مقدار اتریبیوت که میخواهد از متود زیر استفاده کنید
document.querySelector("#ref-link").setAttribute("my-attribute","new-attribute");
